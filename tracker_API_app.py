...
# sticky allows 
welcome_label: tk.Label = tk.Label(window, text="Welcome to the Emoji Tracker!").grid(row=0, column=0, columnspan=1, sticky="W")
description_label: tk.Label = tk.Label(window, text="This app lets you see and track emojis!").grid(row=1, column=0, columnspan=1, sticky="W")
